    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="<?= base_url() ?>/index.html"><img src="<?= base_url() ?>/assets/images/trace.svg" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini" href="<?= base_url() ?>/index.html"><img src="<?= base_url() ?>/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('admin/dekorasi/index') ?>">Dekorasi</a></li>
                <!-- <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/dropdowns.html">Catering</a></li> -->
              </ul>
            </div>
          </li>
          
          <!-- <li class="nav-item menu-items">
            <a class="nav-link" href="<?= base_url('admin/dekorasi/index') ?>">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="<?= base_url('admin/petugas/index') ?>">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item" href="<?= base_url('admin/login/keluar'); ?>">
                    <div class="preview-thumbnail">
                      <div class="preview-icon bg-dark rounded-circle">
                  ...
                  <div class="dropdown-divider"></div>
                  <p class="p-3 mb-0 text-center">Admin</p>
                </div>
              </li>
            </ul>
